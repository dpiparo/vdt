...
static void vdt_vf31(char **args, npy_intp *dimensions,
		  npy_intp* steps, void* data)
{
  void (*functionPtr)(const float* __restrict__, const float* __restrict__, const float* __restrict__, float* __restrict__, long);
  functionPtr = data;
  ...
  (*functionPtr)((const float *)in1, (const float *)in2,(const float *)in3, (float *)out,n); 
}
...
static void vdt_vd31(char **args, npy_intp *dimensions,
		  npy_intp* steps, void* data)
{
  void (*functionPtr)(const double* __restrict__, const double* __restrict__, const double* __restrict__, double* __restrict__, long);
  functionPtr = data;
  ...
  (*functionPtr)((const double *)in1, (const double *)in2,(const double *)in3, (double *)out,n); 
}
...
PyUFuncGenericFunction funcs31[2] = {&vdt_vf31,&vdt_vd31};
...
/* These are the input and return dtypes of vdt_v 3to1*/
static char types31[8] = {NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE};
